...
- **Stock diario:** cada `MenuItem` tiene un campo `daily_stock` (entero, nullable). Si es `null` o `0`, el ítem no es ordenable. Resetea a las 00:00 via Solid Queue.
- **Máximo por ítem por orden:** 10 unidades.
