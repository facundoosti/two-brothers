...
import { getCurrentTenant, getBaseApiUrl } from '@/lib/tenant'
...
type OAuthError = 'oauth_failed' | 'pending'

function isOAuthError(v: string | null): v is OAuthError {
  return v === 'oauth_failed' || v === 'pending'
}
...
export default function LoginPage() {
  ...
  const error: OAuthError | null = isOAuthError(errorParam) ? errorParam : null
  ...
  function handleGoogleLogin() {
    ...
    window.location.href = `${getBaseApiUrl()}/auth/google${params}`
  }
      ...
      <div className="relative z-30 bg-(--color-surface) rounded-t-[24px] px-8 pt-10 pb-12 shadow-[0_-8px_48px_rgba(0,0,0,0.5)]">
        ...
        <div className="max-w-md mx-auto">
          ...
          <button
            ...
            className="w-full bg-white flex items-center justify-center gap-3 py-4 rounded-full transition-transform active:scale-[0.98] duration-200"
          >
            ...
            <span className="text-[#1a1b21] font-semibold text-base">Continuar con Google</span>
          </button>
